...
begin
  ...
  //----------------------------------------------------------
    ...
    if bCD_41_Update then          // Flash Configuration
      ...
      CDProfileData.CurrentConfigData.BF8.CanMessageTime := CD_41_Download.BF8.CanMessageTime;
      move(CD_41_Download.BF8.CanTable, CDProfileData.CurrentConfigData.BF8.CanTable, sizeof(CDProfileData.CurrentConfigData.BF8.CanTable));
      ...
      CDProfileData.CurrentConfigData.BF3.ReverseIndexSlave1 := CD_41_Download.BF3.ReverseIndexSlave1;
      CDProfileData.CurrentConfigData.BF3.ReverseIndexSlave2 := CD_41_Download.BF3.ReverseIndexSlave2;
      CDProfileData.CurrentConfigData.BF3.ReverseIndexSlave3 := CD_41_Download.BF3.ReverseIndexSlave3;
      CDProfileData.CurrentConfigData.BF3.ReverseIndexSlave4 := CD_41_Download.BF3.ReverseIndexSlave4;
      CDProfileData.CurrentConfigData.BF3.ReverseIndexSlave5 := CD_41_Download.BF3.ReverseIndexSlave5;
      CDProfileData.CurrentConfigData.BF3.ReverseIndexSlave6 := CD_41_Download.BF3.ReverseIndexSlave6;
      CDProfileData.CurrentConfigData.BF3.ReverseIndexSlave7 := CD_41_Download.BF3.ReverseIndexSlave7;
      CDProfileData.CurrentConfigData.BF3.ReverseIndexSlave8 := CD_41_Download.BF3.ReverseIndexSlave8;
      CDProfileData.CurrentConfigData.BF3.ReverseIndexSlave9 := CD_41_Download.BF3.ReverseIndexSlave9;
      CDProfileData.CurrentConfigData.BF3.ReverseIndexSlave10 := CD_41_Download.BF3.ReverseIndexSlave10;
    ...
    if bCD_44_Update then          // Event Log
      ...
      for i := 0 to 2047 do
        ...
        case CD_44[StartingIndex].stBFEvent.EventId of
            ...
            25:  TmpStr := 'CAN Not Updating';
            26:  TmpStr := 'Firmware Upload';
            27:  TmpStr := 'FATAL: Stack Overflow imminent!! - Resetting CPU!!';
            28:  TmpStr := 'FATAL: Fuzzy Logic Configuration CRC Invalid';
        ...
        70: begin
           if bNewSiglentValue then
             ...
             if bNext then
               ...
               edtConfigManufacturingNameTester.Text := 'Rick Wright';
               edtConfigManufacturingModelNumber.Text := 'CD2840';
...
begin
  ...
  cbUploadConfigReverseSlave1.Checked := CDProfileData.GuiConfigData.BF3.ReverseIndexSlave1 <> 0;
  cbUploadConfigReverseSlave2.Checked := CDProfileData.GuiConfigData.BF3.ReverseIndexSlave2 <> 0;
  cbUploadConfigReverseSlave3.Checked := CDProfileData.GuiConfigData.BF3.ReverseIndexSlave3 <> 0;
  cbUploadConfigReverseSlave4.Checked := CDProfileData.GuiConfigData.BF3.ReverseIndexSlave4 <> 0;
  cbUploadConfigReverseSlave5.Checked := CDProfileData.GuiConfigData.BF3.ReverseIndexSlave5 <> 0;
  cbUploadConfigReverseSlave6.Checked := CDProfileData.GuiConfigData.BF3.ReverseIndexSlave6 <> 0;
  cbUploadConfigReverseSlave7.Checked := CDProfileData.GuiConfigData.BF3.ReverseIndexSlave7 <> 0;
  cbUploadConfigReverseSlave8.Checked := CDProfileData.GuiConfigData.BF3.ReverseIndexSlave8 <> 0;
  cbUploadConfigReverseSlave9.Checked := CDProfileData.GuiConfigData.BF3.ReverseIndexSlave9 <> 0;
  cbUploadConfigReverseSlave10.Checked := CDProfileData.GuiConfigData.BF3.ReverseIndexSlave10 <> 0;
  ...
  edtUploadConfigCanTime.Text := format('%d', [CDProfileData.GuiConfigData.BF8.CanMessageTime]);
...
begin
  ...
  ProfileStrKey[ProfileStrIndex] := 'SOURCE_ADDREESS';
  ProfileStrValue[ProfileStrIndex] :=  format('%u', [CDProfileData.GuiConfigData.BF8.SensorMode]);
  ProfileStrIndex := ProfileStrIndex + 1;
  ...
  ProfileStrKey[ProfileStrIndex] := 'CAN_TIME';
  ProfileStrValue[ProfileStrIndex] := format('%d', [CDProfileData.GuiConfigData.BF8.CanMessageTime]);
  ProfileStrIndex := ProfileStrIndex + 1;
  ...
  ProfileStrValue[ProfileStrIndex] := format('%u', [CDProfileData.GuiConfigData.BF3.ReverseIndexSlave1]);
  ProfileStrIndex := ProfileStrIndex + 1;

  ProfileStrKey[ProfileStrIndex] := 'SLAVE2_REV';
  ProfileStrValue[ProfileStrIndex] := format('%u', [CDProfileData.GuiConfigData.BF3.ReverseIndexSlave2]);
  ProfileStrIndex := ProfileStrIndex + 1;

  ProfileStrKey[ProfileStrIndex] := 'SLAVE3_REV';
  ProfileStrValue[ProfileStrIndex] := format('%u', [CDProfileData.GuiConfigData.BF3.ReverseIndexSlave3]);
  ProfileStrIndex := ProfileStrIndex + 1;

  ProfileStrKey[ProfileStrIndex] := 'SLAVE4_REV';
  ProfileStrValue[ProfileStrIndex] := format('%u', [CDProfileData.GuiConfigData.BF3.ReverseIndexSlave4]);
  ProfileStrIndex := ProfileStrIndex + 1;

  ProfileStrKey[ProfileStrIndex] := 'SLAVE5_REV';
  ProfileStrValue[ProfileStrIndex] := format('%u', [CDProfileData.GuiConfigData.BF3.ReverseIndexSlave5]);
  ProfileStrIndex := ProfileStrIndex + 1;

  ProfileStrKey[ProfileStrIndex] := 'SLAVE6_REV';
  ProfileStrValue[ProfileStrIndex] := format('%u', [CDProfileData.GuiConfigData.BF3.ReverseIndexSlave6]);
  ProfileStrIndex := ProfileStrIndex + 1;

  ProfileStrKey[ProfileStrIndex] := 'SLAVE7_REV';
  ProfileStrValue[ProfileStrIndex] := format('%u', [CDProfileData.GuiConfigData.BF3.ReverseIndexSlave7]);
  ProfileStrIndex := ProfileStrIndex + 1;

  ProfileStrKey[ProfileStrIndex] := 'SLAVE8_REV';
  ProfileStrValue[ProfileStrIndex] := format('%u', [CDProfileData.GuiConfigData.BF3.ReverseIndexSlave8]);
  ProfileStrIndex := ProfileStrIndex + 1;

  ProfileStrKey[ProfileStrIndex] := 'SLAVE9_REV';
  ProfileStrValue[ProfileStrIndex] := format('%u', [CDProfileData.GuiConfigData.BF3.ReverseIndexSlave9]);
  ProfileStrIndex := ProfileStrIndex + 1;

  ProfileStrKey[ProfileStrIndex] := 'SLAVE10_REV';
  ProfileStrValue[ProfileStrIndex] := format('%u', [CDProfileData.GuiConfigData.BF3.ReverseIndexSlave10]);
  ProfileStrIndex := ProfileStrIndex + 1;
...
begin
  ...
  CDProfileData.GuiConfigData.BF8.CanMessageTime := ConvertToFloat(edtUploadConfigCanTime.Text, 1.0);
  ...
  CDProfileData.GuiConfigData.BF3.ReverseIndexSlave1 := BooleanToInteger(cbUploadConfigReverseSlave1.Checked);
  CDProfileData.GuiConfigData.BF3.ReverseIndexSlave2 := BooleanToInteger(cbUploadConfigReverseSlave2.Checked);
  CDProfileData.GuiConfigData.BF3.ReverseIndexSlave3 := BooleanToInteger(cbUploadConfigReverseSlave3.Checked);
  CDProfileData.GuiConfigData.BF3.ReverseIndexSlave4 := BooleanToInteger(cbUploadConfigReverseSlave4.Checked);
  CDProfileData.GuiConfigData.BF3.ReverseIndexSlave5 := BooleanToInteger(cbUploadConfigReverseSlave5.Checked);
  CDProfileData.GuiConfigData.BF3.ReverseIndexSlave6 := BooleanToInteger(cbUploadConfigReverseSlave6.Checked);
  CDProfileData.GuiConfigData.BF3.ReverseIndexSlave7 := BooleanToInteger(cbUploadConfigReverseSlave7.Checked);
  CDProfileData.GuiConfigData.BF3.ReverseIndexSlave8 := BooleanToInteger(cbUploadConfigReverseSlave8.Checked);
  CDProfileData.GuiConfigData.BF3.ReverseIndexSlave9 := BooleanToInteger(cbUploadConfigReverseSlave9.Checked);
  CDProfileData.GuiConfigData.BF3.ReverseIndexSlave10 := BooleanToInteger(cbUploadConfigReverseSlave10.Checked);
  ...
  UpdateProfile(edtUploadConfigCanBus.Text, 100.0, Label260, UploadCanBusProfileGraph, CDProfileData.GuiConfigData.BF8.CanTable);
...
begin
  ...
  SetIniData(IniFile, ProfileName, 'CAN_TIME', 0, @TmpInt, 1.0);
  CDProfileData.IniConfigData.BF8.CanMessageTime := TmpInt;
  ...
  SetIniData(IniFile, ProfileName, 'SLAVE1_REV', 0, @TmpInt, 1.0);
  CDProfileData.IniConfigData.BF3.ReverseIndexSlave1 := TmpInt;
  SetIniData(IniFile, ProfileName, 'SLAVE2_REV', 0, @TmpInt, 1.0);
  CDProfileData.IniConfigData.BF3.ReverseIndexSlave2 := TmpInt;
  SetIniData(IniFile, ProfileName, 'SLAVE3_REV', 0, @TmpInt, 1.0);
  CDProfileData.IniConfigData.BF3.ReverseIndexSlave3 := TmpInt;
  SetIniData(IniFile, ProfileName, 'SLAVE4_REV', 0, @TmpInt, 1.0);
  CDProfileData.IniConfigData.BF3.ReverseIndexSlave4 := TmpInt;
  SetIniData(IniFile, ProfileName, 'SLAVE5_REV', 0, @TmpInt, 1.0);
  CDProfileData.IniConfigData.BF3.ReverseIndexSlave5 := TmpInt;
  SetIniData(IniFile, ProfileName, 'SLAVE6_REV', 0, @TmpInt, 1.0);
  CDProfileData.IniConfigData.BF3.ReverseIndexSlave6 := TmpInt;
  SetIniData(IniFile, ProfileName, 'SLAVE7_REV', 0, @TmpInt, 1.0);
  CDProfileData.IniConfigData.BF3.ReverseIndexSlave7 := TmpInt;
  SetIniData(IniFile, ProfileName, 'SLAVE8_REV', 0, @TmpInt, 1.0);
  CDProfileData.IniConfigData.BF3.ReverseIndexSlave8 := TmpInt;
  SetIniData(IniFile, ProfileName, 'SLAVE9_REV', 0, @TmpInt, 1.0);
  CDProfileData.IniConfigData.BF3.ReverseIndexSlave9 := TmpInt;
  SetIniData(IniFile, ProfileName, 'SLAVE10_REV', 0, @TmpInt, 1.0);
  CDProfileData.IniConfigData.BF3.ReverseIndexSlave10 := TmpInt;
  ...
  SetIniData(IniFile, ProfileName, 'CAN_BUS_TABLE', 3, @CDProfileData.IniConfigData.BF8.CanTable, 0.0);
...
begin
  Result := '';
  for i := 0 to GuiConfigData.BF8.CanTable.TableLength - 1 do
    begin
    if i <> 0 then Result := Result + ',';
    Result := Result + format('[%1.2f,%1.0f]', [GuiConfigData.BF8.CanTable.TablePoint[i].Point1 / 100.0, GuiConfigData.BF8.CanTable.TablePoint[i].Point2 / 100.0]);
    end;
end;
...
begin
  ParseRecords(NewData, ParseResults);
  GuiConfigData.BF8.CanTable.TableLength := ParseResults.ParseLength;
  for i := 0 to 31 do
    begin
    GuiConfigData.BF8.CanTable.TablePoint[i].Point1 := 0;
    GuiConfigData.BF8.CanTable.TablePoint[i].Point2 := 0;
    if ParseResults.ParseLength > i then
      begin
      GuiConfigData.BF8.CanTable.TablePoint[i].Point1 := round(ParseResults.ParsePoint[i].Point1 * 100.0);
      GuiConfigData.BF8.CanTable.TablePoint[i].Point2 := round(ParseResults.ParsePoint[i].Point2 * 100.0);
      end;
    end;
end;
...
begin
  ...
  GuiConfigData.BF8.CanTable.TableLength := 2;
  GuiConfigData.BF8.CanTable.TablePoint[0].Point1 := 400;
  GuiConfigData.BF8.CanTable.TablePoint[0].Point2 := 320;
  GuiConfigData.BF8.CanTable.TablePoint[1].Point1 := 102300;
  GuiConfigData.BF8.CanTable.TablePoint[1].Point2 := 576;
...
begin
  ...
  CD_41_Upload.BF3.ReverseIndexSlave1 := GuiConfigData.BF3.ReverseIndexSlave1;
  CD_41_Upload.BF3.ReverseIndexSlave2 := GuiConfigData.BF3.ReverseIndexSlave2;
  CD_41_Upload.BF3.ReverseIndexSlave3 := GuiConfigData.BF3.ReverseIndexSlave3;
  CD_41_Upload.BF3.ReverseIndexSlave4 := GuiConfigData.BF3.ReverseIndexSlave4;
  CD_41_Upload.BF3.ReverseIndexSlave5 := GuiConfigData.BF3.ReverseIndexSlave5;
  CD_41_Upload.BF3.ReverseIndexSlave6 := GuiConfigData.BF3.ReverseIndexSlave6;
  CD_41_Upload.BF3.ReverseIndexSlave7 := GuiConfigData.BF3.ReverseIndexSlave7;
  CD_41_Upload.BF3.ReverseIndexSlave8 := GuiConfigData.BF3.ReverseIndexSlave8;
  CD_41_Upload.BF3.ReverseIndexSlave9 := GuiConfigData.BF3.ReverseIndexSlave9;
  CD_41_Upload.BF3.ReverseIndexSlave10 := GuiConfigData.BF3.ReverseIndexSlave10;
  ...
  CD_41_Upload.BF8.CanMessageTime := GuiConfigData.BF8.CanMessageTime;
  move(GuiConfigData.BF8.CanTable, CD_41_Upload.BF8.CanTable, sizeof(CD_41_Upload.BF8.CanTable));
  ...
  CD_41_Upload.BF7.CRC16 := CalcCrcArray(@CD_41_Upload, 2044);
end;
...
begin
  ...
  CD_42_Upload.BF7.CRC16 := CalcCrcArray(@CD_42_Upload, 2044);
end;
...
begin
  ...
  CD_43_Upload.Fuzzy1.BF7.CRC16 := CalcCrcArray(@CD_43_Upload, 2044);
  CD_43_Upload.Fuzzy2.BF7.Version := FUZZY_VERSION;
  CD_43_Upload.Fuzzy2.BF7.CRC16 := CalcCrcArray(@CD_43_Upload, 2044);
end;
