...
// Revision: X1
//
// Description:     CRC8 support routines for CAN Bus
//
// ------------------------------------------------------------------------
//
// ------------------------------------------------------------------------
...
//
// CRC8 Data Table to be used in CalcCrc8
//
static const uint8_t CANcrc8Table[256] =
{
...
// ------------------------------------------------------------------------
//
// CalcCrc8 - Caculate 8-bit Cyclic Redudancy Check (CRC8) value of input data using:
//                     Polynomial: x^8 + x^5 + x^3 + x^2 + x + 1
//
// Params:    data - array of data to use to calculate CRC8
